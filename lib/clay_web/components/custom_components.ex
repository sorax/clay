defmodule ClayWeb.CustomComponents do
  @moduledoc """
  ...
  def page_footer(assigns) do
    ...
    <footer class={[
      ...
      <div class="flex justify-center gap-4 fill-current md:justify-end">
        <.link class="w-6" href="https://github.com/sorax" rel="nofollow" title="GitHub">
        ...
        <.link class="w-6" href="https://chaos.social/@sorax" rel="me" title="Mastodon">
        ...
        <.link
          class="w-6"
          href="https://www.xing.com/profile/Robert_Roeske"
          rel="nofollow"
          title="XING"
        >
